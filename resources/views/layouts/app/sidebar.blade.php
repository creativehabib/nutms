        ...
        <flux:sidebar.header>
            ...
            <flux:sidebar.nav>
                ...
                <flux:sidebar.group expandable icon="cog-8-tooth" :heading="__('Academic Settings')" expandable :expanded="request()->routeIs('reference-data.manage')" class="grid">
                    ...
                    <flux:sidebar.item icon="rectangle-stack" :href="route('reference-data.manage', 'program-levels')" :current="request()->routeIs('reference-data.manage') && request()->route('type') === 'program-levels'" wire:navigate>{{ __('Program Levels') }}</flux:sidebar.item>
                ...
                @if(auth()->user()->isAdmin() )
                    ...
                    <flux:sidebar.item icon="server-stack" :href="route('cache.manager')" :current="request()->routeIs('cache.manager')" wire:navigate>
                        {{ __('Cache Management') }}
                    </flux:sidebar.item>
                @endif
