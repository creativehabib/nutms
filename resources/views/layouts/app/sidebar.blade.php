        ...
        <flux:sidebar sticky collapsible="mobile" class="border-e border-zinc-200 bg-zinc-50 dark:border-zinc-700 dark:bg-zinc-900">
            ...
            <flux:sidebar.nav>
                ...
                <flux:sidebar.group heading="শিক্ষক সেটিংস" expandable :expanded="request()->routeIs('reference-data.manage')" class="grid">
                    ...
                    <flux:sidebar.item icon="building-library" :href="route('reference-data.manage', 'colleges')" :current="request()->routeIs('reference-data.manage') && request()->route('type') === 'colleges'" wire:navigate>কলেজ</flux:sidebar.item>
