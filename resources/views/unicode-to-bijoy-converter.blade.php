    ...
    >
        ...
        <div class="overflow-hidden rounded-3xl border border-slate-200 bg-white shadow-xl shadow-slate-200/50 dark:border-slate-800 dark:bg-slate-900 dark:shadow-black/20">
            ...
            <div class="p-4 sm:p-6">
                ...
                <p data-bijoy-preview-hint class="mb-2 text-xs text-slate-500 dark:text-slate-400">
                    এখানে পাঠযোগ্য বাংলা প্রিভিউ দেখাবে; বাটন, Ctrl/Cmd+C অথবা নির্বাচন করে কপি করলে মূল বিজয়/SutonnyMJ লেখা কপি হবে।
                </p>
                <textarea
