...
>
    <section class="mx-auto max-w-6xl" aria-labelledby="tools-title">
        ...
        <div class="mt-10 grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
            ...
            <div class="flex min-h-72 flex-col items-center justify-center rounded-3xl border border-dashed border-slate-300 bg-white/50 p-6 text-center dark:border-slate-700 dark:bg-slate-900/40">
